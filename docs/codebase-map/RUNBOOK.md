...
| 09 | Curriculum compiler "Studio 26" | SEC-6; FEAT-9, FEAT-13; HYG-6, HYG-45, HYG-52 (`CURRICULUM_KIND_CODES`, status enum + `parentBundleId` FK, skipped artifacts, `suggestCourseBlocks` check, `initialContext`, `Bundle` types, dedupe manifest, QA gate) |
