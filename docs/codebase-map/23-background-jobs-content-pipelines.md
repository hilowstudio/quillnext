...
Q-23-003  [LOW]  ✅ RESOLVED 2026-06-23 — migration 0016 added `DocumentResource.extraction_status` (`ExtractionStatus` enum) and `process-document` now sets `onFailure`→FAILED + EXTRACTED-on-success + `retries:2`. *(Orig: re-graded INFO→LOW 2026-06-19, then deferred to the batched migration that also held ch.02 Q-011/Q-013.)*  — `process-document.ts`
  ...
  Status: ✅ RESOLVED 2026-06-23 — migration 0016 added the `extraction_status` enum + `process-document` `onFailure`/`retries` (see CHANGELOG.md 2026-06-23 round).
